        ...
        <div className={cls.Header} >
            <div className="content">
                <div className={cls.Header_container}>
                    ...
                    <svg className={cls.Header_logo} width="92" height="28" viewBox="0 0 92 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className={cls.Header_location}>
                        <div className={cls.Header_location_text}>
                            <svg className={cls.Header_location_text_icon} width="14" height="20" viewBox="0 0 14 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <Button onClick={toggleModal} className={cls.Header_menu_btn_up} theme={ButtonTheme.GREEN}>Записаться на прием</Button>
                </div>
            </div>
            <div className={cls.Header_menu}>
                <div className="content">
                    ...
                    <div className={classNames(cls.Navbar, { [cls._active_nav]: open }, [])}>
                        ...
                        <Button onClick={toggleModal} className={cls.Header_menu_btn} theme={ButtonTheme.CLEAR_GREEN}>Записаться на прием</Button>
                    </div>
